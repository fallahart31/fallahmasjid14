...
<div  class="nav" >
    ...
    <div class="content-utama">
            <div class="content-isi">
                ...
                <div class="button">
                    <a href="tambah.php" id="btn">Beri Bantuan Shodaqoh Masjid</a>
                </div>
            </div>
            <img src="img/masjidbesar1.jpeg" alt="">
        </div>
    <br><br><br><br><br><br><br>
    <div class="baner1"><img src="img/aljabarnaner.jpeg"></div>
    </head>
<body>
  <div class="card-2">
    <div class="section-2">
  ...
  <h1>04</h1>
    ...
    <?php $i = 1; ?>
        ...
        <div class="container-gambar">
            <div class="gambar">
                <img src="img/masjidbesar.jpeg" alt="">
            </div>
            <div class="gambar">
                <img src="img/masjidbesar.jpeg" alt="">
            </div>
